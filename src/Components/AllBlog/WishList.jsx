...
const WishList = () => {
  ...
  const deleteWishListButton = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`https://my-blog-server-side.vercel.app/popular/${id}`)
          .then((res) => {
  ...
  return (
    <div>
      <Helmet>
        <title>News portal | wishlist page</title>
      </Helmet>
      <Navbar></Navbar>
              ...
              <div className="card w-80 flex flex-col mx-auto  my-10  card-side bg-base-100 shadow-md lg:w-[1270px]">
                ...
                <div className="card-body">
                  ...
                  <div>
                    ...
                    <div className="flex flex-row">
                      <img
                        ...
                        src="https://i.ibb.co/dfKtBR5/a4d5069012f87e153609b338d8b104d4e124e1d6-409x398.png"
                        alt="logo"
                      />
                      <h1 className="text-xl ml-2 font-medium">
                        {blog.author}
                      </h1>
                  ...
                  <div className="card-actions justify-end">
                    ...
                    <button
                      onClick={() => deleteWishListButton(blog._id)}
